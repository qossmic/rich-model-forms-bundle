...
namespace Qossmic\RichModelForms\Tests\Legacy\DependencyInjection\Compiler;
...
class RegisterExceptionHandlersPassTest extends LegacyClassTestCase
{
    protected function createInstance(): object
    {
        return new RegisterExceptionHandlersPass();
    }
}

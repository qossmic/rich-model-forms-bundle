...
class FormExceptionHandlerTest extends LegacyClassTestCase
{
    protected function createInstance(): object
    {
        return new FormExceptionHandler(new ExceptionHandlerRegistry($this->createMock(ContainerInterface::class), []));
    }
}
